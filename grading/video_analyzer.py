"""
Shared video analyzer for LED board grading.

Reads a recorded video of the LED board, extracts per-frame LED on/off
states using a calibration file, and detects the programming→running
transition via the debug LED.

Lab-specific scoring lives in each lab's own score module.
"""
