"""
Gemini-based code review for Lab 2 rubric items.

Single-student review primitives live in assess/lab2_code_review.py.
...
from assess.lab2_code_review import (  # noqa: F401
    RUBRIC_ITEMS,
    RUBRIC_POINTS,
    RUBRIC_DESCRIPTIONS,
    RUBRIC_MAX_POINTS,
...
def review_bulk(student_phase_dirs, *, api_key=None, model=DEFAULT_MODEL,
                verbose=False):
    """
    ...
    Args:
        student_phase_dirs: dict mapping student name ->
            {"phase1": dir, "phase2": dir, "phase3": dir}
    ...
    for name, phase_dirs in student_phase_dirs.items():
        phase_code, doc_files = collect_artifacts(phase_dirs)
        if not phase_code:
            continue
...
"""
    ...
    # ── Auto-chunk: ~6 students per request (Lab 2 has more code) ──
    MAX_STUDENTS_PER_CHUNK = 6
